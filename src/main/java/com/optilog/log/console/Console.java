...
public class Console {
    ...
    public static void file(Optilog instance) {
        ...
        if (!instance.allSetting.defaultConsolePath.equals("")) {
        ...
        if (!instance.allSetting.Path1.equals("")) {
        ...
        if (!instance.allSetting.Path2.equals("")) {
        ...
        if (!instance.allSetting.Path3.equals("")) {
        ...
        if (!instance.allSetting.Path4.equals("")) {
        ...
        if (!instance.allSetting.Path5.equals("")) {
